...
public class TrackedEntityInstanceLatitudeValueModel {
    ...
    public TrackedEntityInstanceLatitudeValueModel(@NonNull String trackedEntityTypeId, @NonNull String trackedEntityAttributeId, @NonNull String trackedEntityInstanceId, @NonNull Double value) {
    ...
    public static class Builder {
        ...
        public TrackedEntityInstanceLatitudeValueModel build() {
            ...
            return new TrackedEntityInstanceLatitudeValueModel(
                    trackedEntityTypeId,
