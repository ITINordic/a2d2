...
public class TrackedEntityInstanceTrackerAssociateValueModel {
    ...
    public TrackedEntityInstanceTrackerAssociateValueModel( @NonNull String trackedEntityAttributeId, @NonNull String trackedEntityInstanceId, @NonNull String value) {
