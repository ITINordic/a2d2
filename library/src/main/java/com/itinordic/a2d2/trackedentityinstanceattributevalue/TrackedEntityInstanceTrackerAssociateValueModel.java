...
public class TrackedEntityInstanceTrackerAssociateValueModel {
    ...
    public TrackedEntityInstanceTrackerAssociateValueModel(@NonNull String trackedEntityTypeId, @NonNull String trackedEntityAttributeId, @NonNull String trackedEntityInstanceId, @NonNull String value) {
    ...
    public static class Builder{
        ...
        public TrackedEntityInstanceTrackerAssociateValueModel build(){
            ...
            return new TrackedEntityInstanceTrackerAssociateValueModel(
                    trackedEntityTypeId,
