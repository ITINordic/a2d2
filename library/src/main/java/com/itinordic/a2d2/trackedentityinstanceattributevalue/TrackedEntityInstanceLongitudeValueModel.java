...
public class TrackedEntityInstanceLongitudeValueModel{
    ...
    public TrackedEntityInstanceLongitudeValueModel(@NonNull String trackedEntityTypeId, @NonNull String trackedEntityAttributeId, @NonNull String trackedEntityInstanceId, @NonNull Double value) {
    ...
    public static class Builder {
        ...
        public TrackedEntityInstanceLongitudeValueModel build() {
            ...
            return new TrackedEntityInstanceLongitudeValueModel(
                    trackedEntityTypeId,
